...
public class CreateDeclinedQuoteNewBusiness extends BaseTest {
  ...
  public HashMap<String, String> getTestData(String testcaseId) {
    ...
    public void createDeclinedQuote(WebDriver driver, HashMap<String,String> dynamicHashMap,ExtentTest extentReport,boolean subAgent) throws Exception {
           
            String tcId = "TC_newBusiness_declined";

            if(subAgent)
              tcId="TC_newBusiness_declined_SA";
            ...
            try {
                 ...
                 nbscreen.riskScreensDeclined(testData, driver, extentReport);
