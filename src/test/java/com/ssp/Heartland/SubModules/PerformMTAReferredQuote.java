...
public class PerformMTAReferredQuote extends BaseTest {
  ...
  public void performMTAReferred(WebDriver driver, String policyNo, HashMap<String, String> dynamicHashMap,
      ExtentTest extentReport) throws Exception {

    String tcId = "TC_MTA_referred";
    ...
    try {
      ...
      nbscreen.riskScreensMTReferred(testData, driver, extentReport);
