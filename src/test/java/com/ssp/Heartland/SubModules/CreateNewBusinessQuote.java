...
public class CreateNewBusinessQuote extends BaseTest {
  ...
  public HashMap<String, String> getTestData(String testcaseId) {
    ...
    public void createNewBusiness(WebDriver driver, HashMap<String,String> dynamicHashMap,ExtentTest extentReport,boolean subAgent) throws Exception {
           
            String tcId = "TC_newBusiness";

            if(subAgent)
              tcId="TC_newBusiness_SA";
