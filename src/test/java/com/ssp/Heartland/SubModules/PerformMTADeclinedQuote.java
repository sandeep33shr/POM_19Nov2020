...
public class PerformMTADeclinedQuote extends BaseTest {
  ...
  public void performMTADeclined(WebDriver driver, String policyNo, HashMap<String, String> dynamicHashMap,
      ExtentTest extentReport) throws Exception {

    String tcId = "TC_MTA_declined";
    ...
    try {
      ...
      nbscreen.riskScreensMTADeclined(testData, driver, extentReport);
