...
public class TC_perform_renewal_what_if_manaul_quote extends BaseTest {
  ...
  public void testCase(WebDriver driver,  HashMap<String, String> testData,
    ...
    try {
      ...
      ViewClientDetails clientDetailsPage = new ViewClientDetails(driver,extentReport).get();
      ...
      if (dynamicHashMap.get("policyNo") != null) {
        ...
        premiumPage.editQuote(driver, extentReport);
        
        quotesPage.switchToForm(driver);
        quotesPage.clickManaulQuote(driver, extentReport);
