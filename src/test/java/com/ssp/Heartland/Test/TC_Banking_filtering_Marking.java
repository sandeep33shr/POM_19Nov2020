...
public class TC_Banking_filtering_Marking extends BaseTest{
  ...
  public void checkBranchColumnAsPerSelectedFilter(WebDriver driver, HashMap<String, String> testData,
  ...
  public void checkMediaTypeColumnAsPerSelectedFilter(WebDriver driver, HashMap<String, String> testData,
      ExtentTest extentReport) throws Exception {
  ...
  public void checkFiltersAvailabilityDynamicallyOnClickingFiltersButton(WebDriver driver, HashMap<String, String> testData,
      ExtentTest extentReport) throws Exception {
  ...
  public void checkFiltersAvailabilityDynamically(WebDriver driver, HashMap<String, String> testData,
      ExtentTest extentReport) throws Exception {
  ...
  public void checkDefaultStateOfButtons(WebDriver driver,
      ExtentTest extentReport) throws Exception {
  ...
  public void checkMarkUnmarkAllBankDynamicStateLogic(WebDriver driver,
      ExtentTest extentReport) throws Exception {
  ...
  public void checkAvailabilityOfPaymentDetails(WebDriver driver,
      ExtentTest extentReport) throws Exception {
  ...
  public void checkAvailabilityOfCollectionDetails(WebDriver driver,
      ExtentTest extentReport) throws Exception {
  ...
  public void checkMarkedStatusFilter(WebDriver driver,
      ExtentTest extentReport) throws Exception {
