...
public class ElementLayer {
   ...
   * <p>
   * If expected element is present on the current page, add to list of value/fields to
   * actualElement list and then compare to expectedElements
   * 
  ...
  public boolean verifyPageElements(List<String> expectedElements, Object obj) throws Exception {
    List<String> actual_elements = new ArrayList<>();
   ...
   * @throws Exception - one of 4 possibilities
   */
  public boolean verifyPageElementsDisabled(List<String> expectedElements, Object obj)
      throws Exception {
   ...
   * <p>
   * If expected element checked/selected on the current page, add to list of value/fields to
   * actualElement list and then compare to expectedElements
   * 
   * @param expectedElements - expected WebElement values
   * @param obj - the page object the elements are on
  ...
  public boolean verifyPageElementsChecked(List<String> expectedElements, Object obj)
      throws Exception {
    List<String> actual_elements = new ArrayList<String>();
    for (String expEle : expectedElements) {
      Field f = null;
   ...
   * <p>
   * If expected element is NOT present on this current page, add to list of value/fields to
   * actualElement list and then compare to expectedElements
   * 
   ...
   */
  public boolean verifyPageElementsDoNotExist(List<String> expectedNotToSee, Object obj)
      throws Exception {
   ...
   * <p>
   * If size of the list element is greater than zero and first element from expected list elements
   * present on the current page, add to list of value/fields to actualElement list and then compare
   * to expectedElements
   * 
  ...
  public boolean verifyPageListElements(List<String> expectedElements, Object obj)
      throws Exception {
    List<String> actual_elements = new ArrayList<String>();
    for (String expEle : expectedElements) {
      Field f = null;
   ...
   */
  @SuppressWarnings("unchecked")
  public boolean verifyPageListElementsDoNotExist(List<String> expectedNotToSee, Object obj)
      throws Exception {
    List<String> actual_elements = new ArrayList<String>();
    for (String expEle : expectedNotToSee) {
      Field f = null;
