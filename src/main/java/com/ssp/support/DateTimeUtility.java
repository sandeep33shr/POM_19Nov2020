...
public class DateTimeUtility {
   ...
   * 
   * @param dateToVerify - actual date
  ...
  /**
   * Method gets the current time from the web clock and convert to mmss format
   * 
   * @return time - web clock time
   */
  ...
  /**
   * Returns the list of installment dates calculated based on given parameters.
   * 
   * @param preferredDay
   * @param totalInstallments
   * @return the installment dates in <code>List</code> representation, or null if no
   *         <code>List</code> representation is applicable.
   */
