...
public class CreatePersonalClient extends LoadableComponent<CreatePersonalClient> {
  ...
  @FindBy(xpath = "//*[contains(text(),'Add Personal Client')]")
  WebElement headerAddPersonalClient;
  
  @FindBy(css="#ctl00_cntMainBody_ddlTitle")
  WebElement dropdownTitle;

  @FindBy(css = "#ctl00_cntMainBody_txtFirstName")
  WebElement fldFirstName;

  @FindBy(css = "#ctl00_cntMainBody_txtLastname")
  ...
  public CreatePersonalClient(WebDriver driver,ExtentTest report) {
    this.driver = driver;
  ...
  protected void isLoaded() throws Error {
    ...
    new WebDriverWait(driver, 30)
        ...
        .withMessage("Add Personal Client not loaded")
        .until(ExpectedConditions.visibilityOf(headerAddPersonalClient));

  }

  /****
   * Method to create a personal client
   * 
   * @param driver
   * @param extentReport
   * @throws Exception
   */
  public void createPersonalClient(WebDriver driver, ExtentTest extentReport) throws Exception {

    
    Timestamp timestamp = new Timestamp(new Date().getTime());
    SimpleDateFormat dateFormat = new SimpleDateFormat("dd.MMM.yy");
    
    UIInteraction.selectDropdownByVisibleText(dropdownTitle, "Title", "Ms", driver, extentReport, false);
    UIInteraction.sendKeys(fldFirstName, "First Name",
        "Personal " + dateFormat.format(timestamp) , driver, extentReport, false);
    UIInteraction.sendKeys(fldLastName, "Last Name", "Client", driver, extentReport, false);
    ...
    UIInteraction.selectDropdownByVisibleText(dropdownContactType, "Contact Type", "Email", driver,
        extentReport, false);
    WaitUtils.waitForSpinner(driver);
    UIInteraction.sendKeys(fldEmail, "Email", "personalClient@gmail.com", driver, extentReport, true);
